...
if (isset($_GET['Numero_empleado'])) {
    ...
    if ($telefono_empleado) {
       ...
       // print_r($response_empleado);
        ...
        // Redirigir a la página de notificación con el número de empleado
        echo '<script type="text/javascript">';
        echo 'window.location.href = "/RH%20VACACIONES/Mensajes_WP/Mensaje_WP_notificacion.php?Numero_empleado=' . $numero_empleado . '";';
        echo '</script>';
    } else {
