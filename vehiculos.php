...
<head>
  ...
  *{box-sizing:border-box} html,body{height:100%}
  ...
  .pair-badge{
    position:initial;right:12px;top:12px;z-index:3;
    display:flex;align-items:center;gap:8px;
    background:#ffffffcc;border:1px solid #e6eef8;
    padding:6px 8px;border-radius:999px;font-size:.78rem;
    backdrop-filter: blur(4px);color:#0f172a;
    max-width: var(--badgeW); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
  }
  .pair-dot{width:8px;height:8px;border-radius:999px;background:var(--pair);border:1px solid rgba(0,0,0,.08)}
  ...
  @media (max-width:520px){
    .pair-badge{position:static;margin-top:6px;align-self:flex-start}
    .card.paired .head{padding-right:0}
  }
  ...
  .status-badge.danger{ background:#fff5f5; border-color:#fecaca; color:#b91c1c; }
  .status-badge.warn  { background:#fffaf0; border-color:#fde68a; color:#92400e; }
